...
let my_user_data = {
  ...
  isHeaterTwoOverrideAllowed : false,
  isWaterPump: false,
  ...
  display : function (){
    console.log("user_data: tempoActive="+this.isTempoActive +
      ", heat1Eco=" + this.isHeaterOneEcoMode+ " override=" + this.isHeaterOneOverrideAllowed  +
      ", heat2Eco=" + this.isHeaterTwoEcoMode+ " override=" + this.isHeaterTwoOverrideAllowed  +
...
function persistHeaterOneOverrideStateAndThenGetHeaterTwoState(response, error_code, error_message, user_data) {
  if(error_code != 200){
    console.log("Error calling get heater One override state " + error_code + " - message: '" + error_message + "' "+JSON.stringify(response));
    return;
  }
  my_user_data.isHeaterOneOverrideAllowed = response.value
...
function persistHeaterTwoOverrideStateAndThenGetProduced(response, error_code, error_message, user_data) {
  if(error_code != 200){
    console.log("Error calling get heater Two override state " + error_code + " - message: '" + error_message + "' - " + JSON.stringify(response));
    return;
  }
  my_user_data.isHeaterTwoOverrideAllowed = response.value
